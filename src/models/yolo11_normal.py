...
trained_model_path = "yolo12_normal/custom-fish-detector/weights/best.pt"
if os.path.exists(trained_model_path):
    shutil.copy(trained_model_path, os.path.join(models_dir, "yolo11_normal_best.pt"))

# Load YOLO model on correct device
model = YOLO(os.path.join(models_dir, "yolo12_normal_best.pt"))
...
print("\n📊 YOLO v12 Model Evaluation Metrics (Original Data):")
