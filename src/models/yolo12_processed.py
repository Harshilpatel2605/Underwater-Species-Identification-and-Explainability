...
trained_model_path = "yolo12_processed/custom-fish-detector/weights/best.pt"
if os.path.exists(trained_model_path):
    shutil.copy(trained_model_path, os.path.join(models_dir, "yolo12_processed_best.pt"))

# Load YOLO model on correct device
model = YOLO(os.path.join(models_dir, "yolo12_processed_best.pt"))
