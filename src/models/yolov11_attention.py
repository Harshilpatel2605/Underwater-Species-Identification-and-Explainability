...
custom_model_yaml = "yolo11-attention.yaml" 
...
project_name = "yolov11_attention" # New project folder name
...
yolo_model.train(
    ...
    imgsz=640,
    batch=16, 
    device="4,5,6,7", # Correct for running directly
    optimizer="AdamW",
...
with open(metrics_file, "w") as f:
    f.write("==== YOLO (attention) Model Test Metrics (Original + Enhanced) ====\n")
